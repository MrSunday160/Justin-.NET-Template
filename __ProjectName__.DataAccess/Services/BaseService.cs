...
namespace __ProjectName__.DataAccess.Services {
    ...
    public class BaseService<TEntity>(__ProjectName__DbContext dbContext) : IBaseService<TEntity> where TEntity : Base {

        private readonly __ProjectName__DbContext _dbContext = dbContext;
